...
void login()
{
	...
	Password[i] = '\0';
    if(strcmp(UserName,"justin")==0 && strcmp(Password,"password")==0)
    {
    	system("cls");
    	loginFrame1();
    	gotoXY(27,10);
...
void intro()
{
	...
	gotoXY(20,11); printf(" Justin Fields");
	gotoXY(20,13); printf("https://github.com/jfields82/Payroll");
	gotoXY(20,15); printf("https://www.linkedin.com/in/justin-fields12/");
